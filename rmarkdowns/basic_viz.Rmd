...
Interpretation:
You can see that in the dense cluster of countries in the top right hand quadrant show that those who have successfully dealt with poverty(SDG1). That cluster also has many light blue shades (SDG7) which indicates high energy scores. From that you can tell the country's poverty and energy usage go hand in hand. 
